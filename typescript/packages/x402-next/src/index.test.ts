...
import { findMatchingRoute, findMatchingPaymentRequirements } from "@peezy.tech/x402/shared";
...
// Mock dependencies
vi.mock("@peezy.tech/x402/verify", () => ({
  useFacilitator: vi.fn(),
}));

vi.mock("@peezy.tech/x402/paywall", () => ({
  getPaywallHtml: vi.fn(),
}));

vi.mock("@peezy.tech/x402/shared", async importOriginal => {
